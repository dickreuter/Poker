...
class UIAction():
    ...
    def open_strategy_analyser(self,ui):
        stragegy_analyser_form = QtGui.QWidget()
        ui_analyser = Ui_Form()
        ui_analyser.setupUi(stragegy_analyser_form)
        ui.window=ui_analyser()
        stragegy_analyser_form.show()
