...
class Ui_Pokerbot(object):
    ...
    def retranslateUi(self, Pokerbot):
        ...
        self.label1.setText(_translate("Pokerbot", "Minimum call equity"))
        self.label_5.setText(_translate("Pokerbot", "Minimum bet equity"))
        ...
        self.label_2.setText(_translate("Pokerbot", "Equity"))
        self.label_9.setText(_translate("Pokerbot", "Last used sheetname"))
        self.label_13.setText(_translate("Pokerbot", "Range"))
        self.label_14.setText(_translate("Pokerbot", "My cards"))
