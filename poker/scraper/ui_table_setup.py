...
class Ui_table_setup_form(object):
    def setupUi(self, table_setup_form):
        ...
        table_setup_form.resize(802, 962)
        self.scrollArea = QtWidgets.QScrollArea(table_setup_form)
        self.scrollArea.setGeometry(QtCore.QRect(10, 590, 761, 341))
        self.scrollArea.setWidgetResizable(True)
        self.scrollArea.setObjectName("scrollArea")
        self.scrollAreaWidgetContents = QtWidgets.QWidget()
        self.scrollAreaWidgetContents.setGeometry(QtCore.QRect(0, 0, 759, 339))
        ...
        self.label_3.setGeometry(QtCore.QRect(530, 420, 131, 16))
        self.label_3.setObjectName("label_3")
        self.tesseract_label = QtWidgets.QLabel(table_setup_form)
        self.tesseract_label.setGeometry(QtCore.QRect(670, 420, 47, 14))
        ...
        self.groupBox_6.setGeometry(QtCore.QRect(260, 30, 223, 201))
        ...
        self.groupBox_7.setGeometry(QtCore.QRect(520, 0, 271, 91))
        self.groupBox_7.setObjectName("groupBox_7")
        self.load = QtWidgets.QPushButton(self.groupBox_7)
        self.load.setGeometry(QtCore.QRect(170, 60, 91, 23))
        ...
        self.groupBox_9.setGeometry(QtCore.QRect(520, 90, 271, 71))
        ...
        self.copy_to_new.setGeometry(QtCore.QRect(100, 40, 91, 23))
        self.copy_to_new.setObjectName("copy_to_new")
        self.new_name = QtWidgets.QLineEdit(self.groupBox_9)
        self.new_name.setGeometry(QtCore.QRect(10, 20, 221, 20))
    ...
    def retranslateUi(self, table_setup_form):
        ...
        self.topleft_corner.setText(_translate("table_setup_form", "Save newly selected top left corner"))
        ...
        self.load_topleft_corner.setText(_translate("table_setup_form", "Load fop left corner"))
