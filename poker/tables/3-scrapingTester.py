...
from poker.tools.mongo_manager import GameLogger, StrategyHandler, re


class MyTableScreenBased(TableScreenBased):
    def __init__(self, p, gui_signals, game_logger, version):
        super(TableScreenBased, self).__init__(p, gui_signals, game_logger, version)
...
class ScrapingTester():
    def __init__(self, table):
        ...
        gui_signals = []
        t = MyTableScreenBased(p, gui_signals, game_logger, '3.05')
