...
class Ui_Pokerbot(object):
    def setupUi(self, Pokerbot):
        ...
        self.auto_act = QtWidgets.QCheckBox(parent=self.centralwidget)
        font = QtGui.QFont()
        font.setPointSize(10)
        self.auto_act.setFont(font)
        self.auto_act.setChecked(True)
        self.auto_act.setObjectName("auto_act")
        self.verticalLayout_7.addWidget(self.auto_act)
    ...
    def retranslateUi(self, Pokerbot):
        ...
        self.auto_act.setText(_translate("Pokerbot", "Act automatically"))
