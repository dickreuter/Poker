...
class TestTableScreenBased(TestCase):
    ...
    def no_test4(self):
        ...
        #     t, _, _, h, _ = init_table('tests/screenshots/1773793_PreFlop_0.png')
        #     t.get_game_number_on_screen(h)
        ...
        #     t, _, _, h, _=init_table('tests/screenshots/751235173_PreFlop_0.png')
        #
        ...
        #     t, _, _, h, _=init_table('tests/screenshots/691119677_PreFlop_0.png')
        #
        ...
        #     t, _, _, h, _=init_table('tests/screenshots/467381034_PreFlop_0.png')
        #
        #     self.assertEqual(t.position_utg_plus, 2)
        #     self.assertEqual(t.dealer_position, 1)
        ...
        #     t, _, _, h, _ = init_table('tests/screenshots/496504338_PreFlop_0.png')
        ...
        #     t, _, _, h, _ = init_table('tests/screenshots/499121363_PreFlop_4.png')
        #     self.assertEqual(t.other_players[0]['pot'], '')
        #     self.assertEqual(t.other_players[1]['pot'], '')
        ...
        #
        # def test_flop(self):
        #     t, _, _, h, _=init_table('tests/screenshots/307380116_Flop_0.png')
        #     self.assertEqual(t.playersBehind, 1)
        #     self.assertEqual(t.playersAhead, 0)
        #
        #     t, _, _, h, _ = init_table('tests/screenshots/712154510_Flop_0.png')
        ...
        #     t, _, _, h, _ = init_table('tests/screenshots/308189727_PreFlop_0.png')
        ...
        #     t, _, _, h, _ = init_table('tests/screenshots/107232845_PreFlop_1.png',round_number=1)
        ...
        #     t, _, _, h, _ = init_table('tests/screenshots/378278828_PreFlop_1.png',round_number=1)
        ...
        #     t, _, _, h, _ = init_table('tests/screenshots/43457283_PreFlop_0.png')
        #     self.assertEqual(t.other_players[0]['pot'], '')
        #     self.assertEqual(t.other_players[1]['pot'], 0.04)
        ...
        #     t, _, _, h, _ = init_table('tests/screenshots/897376414_PreFlop_1.png')
        #     self.assertEqual(t.other_players[0]['pot'], '')
        ...
        #     t, _, _, h, _ = init_table('tests/screenshots/Q9o.png', round_number=0, strategy='snowie1')
        #     self.assertEqual(t.position_utg_plus, 5)
        #     self.assertEqual(t.dealer_position, 4)
        #     self.assertEqual(np.isnan(t.second_raiser), True)
        ...
        #     t, _, _, h, _ = init_table('tests/screenshots/571351571_PreFlop_0.png', round_number=0)
        #     self.assertEqual(t.position_utg_plus, 5)
        #     self.assertEqual(t.dealer_position, 4)
        #     self.assertEqual(np.isnan(t.second_raiser), True)
        ...
        #     t, _, _, h, _ = init_table('tests/screenshots/FundsError1.png')
        #     self.assertEqual(t.myFunds, 8.80)
        #
        # def funds_error2(self):
        #     t, _, _, h, _ = init_table('tests/screenshots/FundsError2.png')
        #     self.assertEqual(t.myFunds, 10.80)
        #
        # def sheet_incorrect_fold(self):
        #     t, _, _, h, _ = init_table('tests/screenshots/49278076_PreFlop_0.png')
