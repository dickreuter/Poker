          ...
          <div className="col-sm">
            ...
            <div className="card shadow-lg rounded custom-card-size">
              <div className="card-body">
                ...
                <div> Version </div>
                <div>
                  <Button onClick={() => goToLink(dlLink)} variant="contained">
                    Download
                  </Button>
                </div>
                <div className="items">
              ...
              <div className="card-body">
                ...
                <div>
                  <Button
                    onClick={() =>
                      goToLink(
                        "https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=YZUR8CYZB826S"
                      )
                    }
                    variant="contained"
                  >
                ...
                <div>
                  ...
                  {showBitcoin && (
                    <div className="small">
                      ...
                      Please email me to confirm once you have made a payment:
              ...
              <div className="card-body">
                ...
                <div>
                  <Button
                    onClick={() =>
                      goToLink(
                        "https://www.paypal.com/cgi-bin/webscr?cmd=_s-xclick&hosted_button_id=PQX6RA3CEEED6"
                      )
                    }
                    variant="contained"
                  >
