...
class TestReverseTables(TestCase):
    ...
    # def test_reversetable_fix(self):
    #     strategy = 'Pokemon4'
    #     # preflop
    #     t, p, gui_signals, h, logger = init_table('tests/screenshots/288461720_PreFlop_0.png', strategy=strategy)
    #     l = MagicMock()
    #     t.totalPotValue = 0.5
    #     t.equity = 0.5
    #     t.checkButton = False
    ...
    #     d.preflop_override(t, logger, h, p)
    #
    #     self.assertEqual('5C3', t.preflop_sheet_name)
    #
    #     preflop_state = CurrentHandPreflopState()
    #     bot_preflop_decision = 'Call'
    #     preflop_state.update_values(t, bot_preflop_decision, h)
    #
    #     # river round 2
    #     t, p, gui_signals, h, logger = init_table('tests/screenshots/288461720_Flop_0.png', strategy=strategy)
    #     for abs_pos in range(5):
    #         if t.other_players[abs_pos]['status'] == 1:
    #             sheet_name = preflop_state.get_reverse_sheetname(abs_pos, t)
    #
    #     self.assertEqual('3C5', sheet_name)